 ...
 * 查询连接列表
 */
const getList = createRequest<IPageParams, IPageResponse<IConnectionListItem>>('/api/connection/datasource/list', {});
...
const close = createRequest<IConnectionDetails, void>('/api/connection/datasource/close', {
  method: 'post',
});
...
const update = createRequest<IConnectionDetails, void>('/api/connection/datasource/update', {
  method: 'post',
});

const remove = createRequest<{ id: number }, void>('/api/connection/datasource/:id', {
  method: 'delete',
});

const clone = createRequest<{ id: number }, number>('/api/connection/datasource/clone', {
  method: 'post',
});
...
const getEnvList = createRequest<void, IConnectionEnv[]>('/api/common/environment/list_all', {
  errorLevel: false,
});
