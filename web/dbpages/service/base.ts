import { navigate } from '@/dbpages/utils';
import { message } from 'antd';
import { ResponseError, extend, type RequestOptionsInit } from 'umi-request';
...
const outsideUrlPrefix =
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-expect-error
  typeof window !== 'undefined' && (window._appGatewayParams.baseUrl || 'http://test.sqlgpt.cn/gateway');
