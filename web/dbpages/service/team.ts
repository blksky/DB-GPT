import { IConnectionDetails, IPageParams, IPageResponse } from '@/dbpages/typings';
import {
  IDataSourceAccessObjectVO,
  IDataSourceVO,
  ITeamAndUserVO,
  ITeamVO,
...
const updateUserAndTeamListFromDataSource = createRequest<
  { dataSourceId: number; accessObjectList: Array<{ id: number; type: RoleType }> },
  number
...
/** 用户-用户管理中添加链接 */
const getDataSourceListFromUser = createRequest<IPageParams & { userId: number }, IPageResponse<IUserWithDataSourceVO>>(
...
/** 用户-用户管理中更新链接 */
const updateDataSourceListFromUser = createRequest<{ userId: number; dataSourceIdList: number[] }, number>(
...
/** 用户-用户管理中添加归属链接 */
const getDataSourceListFromTeam = createRequest<IPageParams & { userId: number }, IPageResponse<ITeamWithDataSourceVO>>(
...
/** 用户-用户管理中更新归属链接 */
const updateDataSourceListFromTeam = createRequest<{ userId: number; dataSourceIdList: number[] }, number>(
