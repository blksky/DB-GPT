export default {
  ...
  'login.text.welcome': 'ChatBIをご利用いただき、ありがとうございます',
  'login.text.tips': 'ChatBIのアカウントはチームの協力と管理のためにのみ使用されます',
  ...
  'login.tips.defaultPassword': 'デフォルトのユーザー名とパスワードは両方とも chatbi です',
};
