export default {
  ...
  'setting.placeholder.chat2dbApiKey': 'ChatBIが提供するAPIキーを使用します',
  ...
  'setting.chat2db.ai.button': 'より強力なAI機能を体験するために、ChatBIをご利用ください',
  'setting.title.goto.chat2db.pro': 'ChatBIへ行く',
};
