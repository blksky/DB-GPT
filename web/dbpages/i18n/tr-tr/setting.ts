export default {
  ...
  'setting.placeholder.chat2dbApiKey': "ChatBI tarafından sağlanan APIKEY'i kullanın",
  ...
  'setting.chat2db.ai.button': `Daha güçlü AI özellikleri için lütfen ChatBI'yu ziyaret edin`,
  'setting.title.goto.chat2db.pro': `ChatBI Pro'ya Git`,
};
