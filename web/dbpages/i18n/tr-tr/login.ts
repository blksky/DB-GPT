export default {
  ...
  'login.text.welcome': "ChatBI'ye Hoş Geldiniz",
  'login.text.tips': 'ChatBI hesabı yalnızca takım işbirliği yönetimi içindir.',
  ...
  'login.tips.defaultPassword': 'Varsayılan kullanıcı adı ve şifre: chatbi',
};
