export default {
  ...
  'login.text.welcome': 'Welcome to ChatBI',
  'login.text.tips': 'The ChatBI account is only for team collaboration management.',
  ...
  'login.tips.defaultPassword': 'The default user name and password are: chatbi',
};
