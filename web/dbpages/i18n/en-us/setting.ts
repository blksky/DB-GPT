export default {
  ...
  'setting.placeholder.chat2dbApiKey': 'Use the APIKEY provided by ChatBI',
  ...
  'setting.chat2db.ai.button': 'Please visit ChatBI for more powerful AI features',
  'setting.title.goto.chat2db.pro': 'Go to ChatBI',
};
