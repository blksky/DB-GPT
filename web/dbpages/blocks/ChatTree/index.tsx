import { databaseMap, TreeNodeType } from '@/dbpages/constants';
...
import LoadingGracile from '@/dbpages/components/Loading/LoadingGracile';
import MenuLabel from '../../components/MenuLabel';
import { useCommonStore } from '@/dbpages/store/common';
import { ITreeNode } from '@/dbpages/typings/tree';
import { setCurrentWorkspaceGlobalExtend } from '@/pages/dbpages/workspace/store/common';
...
import { ITreeConfigItem, switchIcon, treeConfig } from './treeConfig';
import { clearChatTreeStore, setFocusId, setFocusTreeNode, useChatTreeStore } from './treeStore';
...
const TreeNode = memo((props: TreeNodeIProps) => {
  ...
  // 当前节点是否是focus
  const isFocus = useChatTreeStore(state => state.focusId) === treeNodeData.uuid;
  ...
  const treeNodeDom = useMemo(() => {
    ...
    return (
      ...
      >
        <Tooltip placement='right' color={Constants.TOOLTIP_COLOR} title={treeNodeData.comment}>
          <div
