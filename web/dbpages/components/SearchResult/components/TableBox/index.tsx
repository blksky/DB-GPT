import ScreeningResult from '@/dbpages/components/SearchResult/components/ScreeningResult';
import { ArtColumn, BaseTable, SortItem, features, useTablePipeline } from 'ali-react-table';
...
// import { Context } from '@/pages/dbpages/components/SearchResult';

// 样式
import styles from './index.module.less';

// 工具函数
import { downloadFile } from '@/dbpages/utils/file';
import { compareStrings } from '@/dbpages/utils/sort';
import { transformInputValue } from '../../utils';

// 类型定义
import { CRUD } from '@/dbpages/constants';
import { TableDataType } from '@/dbpages/constants/table';
import { IManageResultData, IResultConfig } from '@/dbpages/typings/database';
import { ExportSizeEnum, ExportTypeEnum } from '@/dbpages/typings/resultTable';

// api
import sqlService, { IExecuteSqlParams, IExportParams } from '@/dbpages/service/sql';

// store
import { setFocusedContent } from '@/dbpages/store/common/copyFocusedContent';
...
export default function TableBox(props: ITableProps) {
  ...
  const handleExportSQLResult = async (exportType: ExportTypeEnum, exportSize: ExportSizeEnum) => {
    ...
    downloadFile(getBaseURL() + '/api/rdb/dml/export', params);
  };
