              ...
              return (
                <div key={index} className={styles.outputItem}>
                  <div className={styles.timeBox}>
                    <Iconfont
                      classNameBox={classnames(styles.timeBoxIcon, {
                        [styles.failureIconBox]: item.status !== 'success',
                      })}
                      box
                      boxSize={20}
                      code='&#xe650;'
                  ...
                  <div className={styles.executedDatabaseBox}>
                    ...
                    <div className={styles.executedDatabase}>{nameList.filter(name => name).join(' > ')}</div>
                  </div>
