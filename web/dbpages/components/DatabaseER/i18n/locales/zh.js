...
const zh = {
  translation: {
    ...
    language: '语言',
    flush_storage: '清除存储',
    are_you_sure_flush_storage: '您确定要清除存储吗？此操作将无法恢复地删除您所有的图表和自定义模板。',
    ...
    no_subject_areas_text: '添加区域以分组表！',
    no_notes: '空空如也',
    ...
    no_values_for_field: "表 '{{tableName}}' 的 '{{fieldName}}' 字段类型为 `{{type}}`，但未指定任何值",
    ...
    no_values_for_type_field: "类型 '{{typeName}}' 的 '{{fieldName}}' 字段类型为 `{{type}}`，但未指定任何值",
