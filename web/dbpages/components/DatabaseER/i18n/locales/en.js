...
const en = {
  translation: {
    ...
    are_you_sure_delete_diagram: 'Are you sure you want to delete this diagram? This operation is irreversible.',
    ...
    not_null_is_null: "'{{fieldName}}' field of table '{{tableName}}' is NOT NULL but has default NULL",
    ...
    generic: 'Generic',
    generic_description: 'Generic diagrams can be exported to any SQL flavor but support few data types.',
    enums: 'Enums',
    add_enum: 'Add enum',
