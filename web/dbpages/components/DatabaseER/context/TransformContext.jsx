...
export default function TransformContextProvider({ children }) {
  ...
  const setTransform = useCallback(
    actionOrValue => {
      ...
      const findFirstNumber = (...values) => values.find(value => typeof value === 'number' && !isNaN(value));
  ...
  return <TransformContext.Provider value={{ transform, setTransform }}>{children}</TransformContext.Provider>;
}
