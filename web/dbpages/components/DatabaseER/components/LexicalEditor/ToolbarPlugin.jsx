...
function BlockOptionsDropdownList({ editor, blockType }) {
  ...
  return (
    <Dropdown
      ...
      render={
        <Dropdown.Menu>
          <Dropdown.Item onClick={formatParagraph} icon={<i className={`bi ${blockTypeToIcon.paragraph}`} />}>
            Paragraph
          </Dropdown.Item>
          <Dropdown.Item onClick={formatLargeHeading} icon={<i className={`bi ${blockTypeToIcon.h1}`} />}>
            Large Heading
          </Dropdown.Item>
          <Dropdown.Item onClick={formatSmallHeading} icon={<i className={`bi ${blockTypeToIcon.h2}`} />}>
            Small Heading
          </Dropdown.Item>
          <Dropdown.Item onClick={formatBulletList} icon={<i className={`bi ${blockTypeToIcon.ul}`} />}>
            Bullet List
          </Dropdown.Item>
          <Dropdown.Item onClick={formatNumberedList} icon={<i className={`bi ${blockTypeToIcon.ol}`} />}>
            Numbered List
          </Dropdown.Item>
          <Dropdown.Item onClick={formatQuote} icon={<i className={`bi ${blockTypeToIcon.quote}`} />}>
            Quote
          </Dropdown.Item>
