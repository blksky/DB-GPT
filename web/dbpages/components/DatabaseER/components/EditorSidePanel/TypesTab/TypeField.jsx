...
import { Button, Col, Input, InputNumber, Popover, Row, Select, TagInput } from '@douyinfe/semi-ui';
import { useState } from 'react';
import { useTranslation } from 'react-i18next';
import { Action, ObjectType } from '../../../data/constants';
import { dbToTypes } from '../../../data/datatypes';
import { useDiagram, useEnums, useTypes, useUndoRedo } from '../../../hooks';
      ...
      <Col span={11}>
        <Select
          ...
          optionList={[
            ...
            ...types
              .filter(type => type.name.toLowerCase() !== data.name.toLowerCase())
              .map(type => ({
          ...
          onChange={value => {
            ...
            if (value === 'ENUM' || value === 'SET') {
            ...
            } else if (dbToTypes[database][value].isSized || dbToTypes[database][value].hasPrecision) {
              updateType(tid, {
                fields: types[tid].fields.map((e, id) =>
                  id === fid
                    ? {
              ...
              updateType(tid, {
                fields: types[tid].fields.map((e, id) => (id === fid ? { ...data, type: value } : e)),
              });
            }
          }}
        />
              ...
              {(data.type === 'ENUM' || data.type === 'SET') && (
                <>
                  ...
                  <TagInput
                    ...
                    onChange={v =>
                      updateType(tid, {
                        fields: types[tid].fields.map((e, id) => (id === fid ? { ...data, values: v } : e)),
                      })
                    }
              ...
              {dbToTypes[database][data.type].isSized && (
                <>
                  ...
                  <InputNumber
                    ...
                    onChange={value =>
                      updateType(tid, {
                        fields: types[tid].fields.map((e, id) => (id === fid ? { ...data, size: value } : e)),
                      })
                    }
