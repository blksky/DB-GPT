...
import { Button, Card, Col, Collapse, Input, Row, TextArea } from '@douyinfe/semi-ui';
import { useState } from 'react';
import { useTranslation } from 'react-i18next';
import { Action, ObjectType } from '../../../data/constants';
import { useDiagram, useTypes, useUndoRedo } from '../../../hooks';
    ...
    <div id={`scroll_type_${index}`}>
      ...
      >
        ...
        <Row gutter={6} className='mt-2'>
          ...
          <Col span={12}>
            <Button icon={<IconDeleteStroked />} type='danger' onClick={() => deleteType(index)} block>
              {t('delete')}
            </Button>
          </Col>
        </Row>
