...
import { Action, ObjectType, State, Tab, defaultBlue } from '../../data/constants';
import { useAreas, useCanvas, useLayout, useSaveState, useSelect, useSettings, useUndoRedo } from '../../hooks';
...
export default function Area({ data, onPointerDown, setResize, setInitCoords }) {
  ...
  const areaIsSelected = () =>
    selectedElement.element === ObjectType.AREA && selectedElement.id === data.id && selectedElement.open;
        ...
        <div
          className={`border-2 ${
            isHovered
              ...
              : selectedElement.element === ObjectType.AREA && selectedElement.id === data.id
                ? 'border-blue-500'
                : 'border-slate-400'
