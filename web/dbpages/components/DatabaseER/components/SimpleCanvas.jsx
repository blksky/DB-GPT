    ...
    <g className='select-none'>
      ...
      {pathRef.current && (
        <>
          ...
          <text x={start.x} y={start.y} fill='white' strokeWidth='0.5' textAnchor='middle' alignmentBaseline='middle'>
            {cardinalityStart}
          </text>
          <circle cx={end.x} cy={end.y} r='12' fill='grey' />
          <text x={end.x} y={end.y} fill='white' strokeWidth='0.5' textAnchor='middle' alignmentBaseline='middle'>
            {cardinalityEnd}
          </text>
        </>
      )}
