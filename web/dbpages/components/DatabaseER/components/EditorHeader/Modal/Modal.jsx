...
export default function Modal({ modal, setModal, title, setTitle, setDiagramId, exportData, setExportData, importDb }) {
  ...
  const parseSQLAndLoadDiagram = () => {
    ...
    try {
      ...
      if (importSource.overwrite) {
        ...
        setTables(prev => [...prev, ...diagramData.tables].map((t, i) => ({ ...t, id: i })));
  ...
  const getModalBody = () => {
    switch (modal) {
      ...
      case MODAL.IMPORT_SRC:
        return (
          <ImportSource importData={importSource} setImportData={setImportSource} error={error} setError={setError} />
        );
      case MODAL.NEW:
