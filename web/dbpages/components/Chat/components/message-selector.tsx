...
import styles from './message-selector.module.less';
    ...
    <div className={styles['message-selector']}>
      <div className={styles['message-filter']}>
        ...
        <div className={styles['actions']}>
          <IconButton text={Locale.Select.All} bordered className={styles['filter-item']} onClick={selectAll} />
          <IconButton
      ...
      <div className={styles['messages']}>
        {messages.map((m, i) => {
          ...
          return (
            <div
              className={`${styles['message']} ${props.selection.has(m.id!) && styles['message-selected']}`}
              key={i}
              onClick={() => {
                props.updateSelection(selection => {
            ...
            >
              <div className={styles['avatar']}>
                {m.role === 'user' ? (
                  ...
                  <MaskAvatar avatar={session.mask.avatar} model={m.model || session.mask.modelConfig.model} />
                )}
              </div>
