...
import { ChatMessage, EnumChatStoreType, ModelType } from '../store';
import { ChatGPTApi, IChatSrcData } from './platforms/catlai';
...
export interface ChatOptions {
  ...
  onUpdateInfo?: (options: Record<string, any>) => void;
  onUpdateFlow?: (data: IChatSrcData) => void;
  onFinish: (data: IChatSrcData) => void;
