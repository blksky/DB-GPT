import { DatabaseTypeCode, OperationColumn, TreeNodeType, WorkspaceTabType } from '@/dbpages/constants/';
import i18n from '../../../../../dbpages/i18n';
import sqlServer from '@/dbpages/service/sql';
import { IPageParams } from '@/dbpages/typings/index';
...
// ----- components -----
import { getRightClickMenu } from '@/dbpages/blocks/Tree/hooks/useGetRightClickMenu';
...
// ----- store -----
import { addWorkspaceTab } from '@/pages/dbpages/workspace/store/console';
    ...
    return (
      <div
        className={classnames(styles.tableCell, {
          [styles.activeTableCell]: activeId === record.key,
        })}
      >
        {text}
      </div>
