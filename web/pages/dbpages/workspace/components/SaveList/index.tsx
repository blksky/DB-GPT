import { ConsoleOpenedStatus, workspaceTabConfig } from '@/dbpages/constants/';
...
import { IConsole, ITreeNode } from '@/dbpages/typings/index';
import { approximateList } from '../../../../../dbpages/utils';
import { useWorkspaceStore } from '@/pages/dbpages/workspace/store';
import { addWorkspaceTab, getSavedConsoleList } from '@/pages/dbpages/workspace/store/console';
