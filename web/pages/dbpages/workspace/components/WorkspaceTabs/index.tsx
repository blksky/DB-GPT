...
// ----- constants -----
import { workspaceTabConfig, WorkspaceTabType } from '@/dbpages/constants/';
import { IWorkspaceTab } from '@/dbpages/typings/index';

// ----- components -----
import DatabaseTableEditor from '@/dbpages/blocks/DatabaseTableEditor';
import Iconfont from '../../../../../dbpages/components/Iconfont';
import ShortcutKey from '../../../../../dbpages/components/ShortcutKey';
import Tabs, { ITabItem } from '../../../../../dbpages/components/Tabs';
import SearchResult from '../../../../../dbpages/components/SearchResult';
import SQLExecute from '../SQLExecute';
import ViewAllTable from '../ViewAllTable';

// ---- store -----
import { useTreeStore } from '@/dbpages/blocks/Tree/treeStore';
...
import {
  ...
  setActiveConsoleId,
  setWorkspaceTabList,
} from '@/pages/dbpages/workspace/store/console';

// ----- services -----
import historyService from '@/dbpages/service/history';

import DatabaseER from '../../../../../dbpages/components/DatabaseER';
import indexedDB, { EnumIndexedDbType, EnumIndexedTableType } from '../../../../../dbpages/indexedDB';
...
const WorkspaceTabs = memo(() => {
  ...
  const closeWindowTab = (key: number) => {
    ...
    historyService.updateSavedConsole(p).then(() => {
      indexedDB.deleteData(EnumIndexedDbType.CHAT_BI, EnumIndexedTableType.CHATBI_DDL_TABLE, key);
    });
  };
    ...
    return (
      <SQLExecute
        boundInfo={{
          ...
          executeOnInit: uniqueData.executeOnInit,
        }}
